          ...
          <CardContent>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <Link href="/admin/projects">
                <div className="p-4 border-2 border-gray-200 rounded-lg hover:border-[#0DCAF0] hover:bg-gradient-to-br hover:from-[#faf7f2] hover:to-[#f5f0e8] transition-all cursor-pointer group">
                  <FolderKanban className="h-8 w-8 text-[#0DCAF0] mb-2 group-hover:scale-110 transition-transform" />
              ...
              <Link href="/admin/images">
                <div className="p-4 border-2 border-gray-200 rounded-lg hover:border-[#0DCAF0] hover:bg-gradient-to-br hover:from-[#faf7f2] hover:to-[#f5f0e8] transition-all cursor-pointer group">
                  <Image className="h-8 w-8 text-[#0DCAF0] mb-2 group-hover:scale-110 transition-transform" />
              ...
              <Link href="/admin/content">
                <div className="p-4 border-2 border-gray-200 rounded-lg hover:border-[#0DCAF0] hover:bg-gradient-to-br hover:from-[#faf7f2] hover:to-[#f5f0e8] transition-all cursor-pointer group">
                  <FileText className="h-8 w-8 text-[#0DCAF0] mb-2 group-hover:scale-110 transition-transform" />
